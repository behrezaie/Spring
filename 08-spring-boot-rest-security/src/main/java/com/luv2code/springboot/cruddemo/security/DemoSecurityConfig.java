...
public class DemoSecurityConfig {
    ...
    // we don't need this method anymore since we are using JDBC authentication
    // @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(configurer ->
                ...
                // disable CSRF (cross site request forgery) for POST, PUT, DELETE requests
                // in general, not required for stateless REST APIs that use POST, PUT, DELETE and/or PATCH requests
